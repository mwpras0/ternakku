			...
			<div class="col-lg-3 col-md-6 special-grid best-seller">
				<div class="products-single fix">
					<div class="box-img-hover">
						<img src="<?= base_url() ?>./upload/hewan/<?= $hw->foto_hewan ?>" class="img-fluid" alt="Image" style="width: contain; height: 250px; object-fit: cover;"q	>
						<div class="mask-icon">
							<ul>
								<li><a href="<?= base_url('User/HomeUser/detail_hewan/') . $hw->id_hewan?>" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
							</ul>
