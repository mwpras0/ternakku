                            ...
                            <tbody>
                                <?php
                                  foreach($hewan as $hwn){
                                      ?>
                                <tr>
                                    <td><img src="<?= base_url() ?>./upload/hewan/<?= $hwn->foto_hewan ?>" height="100"
                                            width="100">
                                    </td>
                                    <td><?= $hwn->nama_hewan?></td>
                                    <td><?= $hwn->harga_hewan?></td>
                                    <td><?= $hwn->qty?></td>
                                    <td>
                                        <?= $hwn->harga_hewan * $hwn->qty?>
                                    </td>
                                    <td class="remove-pr">
                                        <a href="<?= base_url('user/keranjang/delete_cart/' . $hwn->id_keranjang)?>">
